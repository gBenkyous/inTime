...
import (
	...
	"intimeServer/ent"
	"intimeServer/ent/car"
	"intimeServer/ent/group"
...
func DbTest2() {
	...
	client, err := ent.Open("mysql", "user:pass@tcp(192.168.0.106:8081)/sample01?charset=utf8mb4&parseTime=True") // SQLドライバ接続 ここ注意！記載通りにすること
	if err != nil {
